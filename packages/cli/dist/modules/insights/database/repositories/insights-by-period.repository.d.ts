...
export declare class InsightsByPeriodRepository extends Repository<InsightsByPeriod> {
    ...
    getPreviousAndCurrentPeriodTypeAggregates({ periodLengthInDays, projectId, }: {
    ...
    getInsightsByWorkflow({ maxAgeInDays, skip, take, sortBy, projectId, }: {
        maxAgeInDays: number;
        skip?: number;
        take?: number;
        sortBy?: string;
    ...
    getInsightsByTime({ maxAgeInDays, periodUnit, insightTypes, projectId, }: {
        maxAgeInDays: number;
