...
let InsightsService = class InsightsService {
    ...
    async getInsightsSummary({ periodLengthInDays, projectId, }) {
    ...
    async getInsightsByWorkflow({ maxAgeInDays, skip = 0, take = 10, sortBy = 'total:desc', projectId, }) {
    ...
    async getInsightsByTime({ maxAgeInDays, periodUnit, insightTypes = Object.keys(insights_shared_1.TypeToNumber), projectId, }) {
