...
Return "Good morning" if time is before 10am, "Good day" it's before 5pm, otherwise "Good evening"`,
  ...
  "ndv.output": "Output",
  "ndv.output.ai.empty": "\u{1F448} Use these logs to see information on how the {node} node completed processing. You can click on a node to see the input it received and data it output.",
  ...
  "workflows.empty.heading": "\u{1F44B} Welcome {name}!",
  "workflows.empty.heading.userNotSetup": "\u{1F44B} Welcome!",
...
var I18nClass = (_class = class {constructor() { _class.prototype.__init.call(this);_class.prototype.__init2.call(this); }
  ...
  baseText(key, options) {
    ...
    const interpolate = { ..._optionalChain([options, 'optionalAccess', _ => _.interpolate]) };
    let result;
    if (_optionalChain([options, 'optionalAccess', _2 => _2.adjustToNumber]) !== void 0) {
  ...
  nodeText(activeNodeType) {
    ...
    return {
      ...
      inputLabelDisplayName(parameter, path) {
        const middleKey = _chunkMOPMPZJOcjs.deriveMiddleKey.call(void 0, path, parameter);
        return context.dynamicRender({
      ...
      placeholder(parameter, path) {
        ...
        if (_chunkMOPMPZJOcjs.isNestedInCollectionLike.call(void 0, path)) {
          const pathSegments = _chunkMOPMPZJOcjs.normalize.call(void 0, path).split(".");
          middleKey = _chunkMOPMPZJOcjs.insertOptionsAndValues.call(void 0, pathSegments).join(".");
        }
        return context.dynamicRender({
  ...
  __init2() {this.autocompleteUIValues = {
