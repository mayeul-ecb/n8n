const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-U_ALDFba.js","assets/index-DuP9JBY4.js","assets/index-CJayXeIf.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-DdhbGyvP.js","assets/chartjs.utils-DmnFc5D3.js","assets/InsightsSummary-eT0MF1z0.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-CBGhaoIF.js","assets/InsightsChartFailed-BOGxyak-.js","assets/InsightsChartFailureRate-RvdRdl1K.js","assets/InsightsChartTimeSaved-CwZWdOSq.js","assets/InsightsChartAverageRuntime-BjzMbtGX.js","assets/InsightsTableWorkflows-LWOGuv4n.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, em as useModel, gh as useInsightsStore, gr as getTimeRangeLabels, r as ref, hb as UNLICENSED_TIME_RANGE, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, A as renderList, l as unref, ed as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, ec as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, hc as ElDialog, aB as usePageRedirectionHelper, _ as _export_sfc, a3 as useRoute, av as useProjectsStore, hd as INSIGHT_TYPES, dx as defineAsyncComponent, a8 as watch, o as onMounted, ay as useDocumentTitle, b2 as onBeforeMount, m as N8nHeading, n as normalizeClass, fI as ProjectSharing, dN as _sfc_main$4, c5 as resolveDynamicComponent, aV as __vitePreload, am as useTelemetry, he as TELEMETRY_TIME_RANGE } from "./index-DuP9JBY4.js";
import { I as InsightsSummary } from "./InsightsSummary-eT0MF1z0.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-U_ALDFba.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-DdhbGyvP.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-BOGxyak-.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-RvdRdl1K.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-CwZWdOSq.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-BjzMbtGX.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-LWOGuv4n.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
