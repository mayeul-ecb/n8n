...
export const NoUntypedConfigClassFieldRule = ESLintUtils.RuleCreator.withoutDocs({
    meta: {
        ...
        messages: {
            noUntypedConfigClassField: 'Class field must have an explicit type annotation, e.g. `field: type = value`. See: https://github.com/n8n-io/n8n/pull/10433',
        },
        schema: [],
    },
    defaultOptions: [],
...
//# sourceMappingURL=no-untyped-config-class-field.js.map